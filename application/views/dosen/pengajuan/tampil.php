		...
		<tbody>
			<?php foreach ($pengajuan as $key => $value): ?>
				<tr>
					...
					<td>
						<?php if ($cek=="ada"): ?>
							<?php if ($value['status_pengajuan']=="Diterima"): ?>
								<a href="<?php echo base_url("dosen/pengajuan/jadwal/$value[id_pengajuan]") ?>" class="btn btn-success btn-xs">Input Jadwal Ujian</a>
								<?php else: ?>
