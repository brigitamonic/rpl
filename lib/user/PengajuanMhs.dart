...
class AddEditPagePengajuanMhs extends StatefulWidget {
  final List list;
  final int index;
  AddEditPagePengajuanMhs({this.list,this.index});
  @override
  _AddEditPagePengajuanMhs createState() => _AddEditPagePengajuanMhs();

}

class pengajuanmhs extends StatelessWidget{
  @override
...
class _AddEditPagePengajuanMhs extends State<AddEditPagePengajuanMhs> {


  var _formKey =  GlobalKey<FormState>();
  TextEditingController id_pengajuan = TextEditingController();
