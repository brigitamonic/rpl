...
import 'Data DiriDosen.dart';

class AddEditPageDosenk extends StatefulWidget {
  final List list;
  final int index;
  AddEditPageDosenk({this.list,this.index});
  @override
  _AddEditPageDosenStatek createState() => _AddEditPageDosenStatek();
}

class _AddEditPageDosenStatek extends State<AddEditPageDosenk> {
  String _jk="";
          ...
          Padding(padding: EdgeInsets.all(8),
            child: RaisedButton(
              onPressed: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => DataDiriDosenk(),),);
