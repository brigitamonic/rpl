...
import 'Data DiriUser.dart';

class AddEditPagek extends StatefulWidget {
  final List list;
  final int index;
  AddEditPagek({this.list,this.index});
  @override
  _AddEditPageStatek createState() => _AddEditPageStatek();
}

class _AddEditPageStatek extends State<AddEditPagek> {
  String _jk="";
